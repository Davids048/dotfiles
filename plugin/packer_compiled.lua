...
_G.packer_plugins = {
  ...
  ale = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/david/.local/share/nvim/site/pack/packer/opt/ale",
    url = "https://github.com/w0rp/ale"
  },
  ["bufferline.nvim"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/bufferline.nvim",
  ...
  ["darkplus.nvim"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/darkplus.nvim",
  ...
  ["toggleterm.nvim"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/toggleterm.nvim",
  ...
  ["vim-bbye"] = {
    loaded = true,
    path = "/Users/david/.local/share/nvim/site/pack/packer/start/vim-bbye",
